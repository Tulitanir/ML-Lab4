...
Цель данной практической работы — реализация свёрточной нейронной сети EfficientNet для классификации изображений набора данных Swedish Flowers с применением современных фреймворков глубокого обучения.
